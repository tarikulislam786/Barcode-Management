    ...
    <div class="row">
        <div class="well col-md-5 center login-box">
            ...
            <div class="row">
                ...
                <div class="col-md-12"><a href="register.php"><button type="button" class="btn btn-primary">Register</button></a></div>
        ...
        <div class="text-center" ng-include="'tpl/blocks/page_footer.html'">
            <p>
                <small class="text-muted">Copyright © 2018 - www.abna-mattar.com</small>
            </p>
        </div>
        <div class="row">
